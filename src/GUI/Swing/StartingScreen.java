...
public class StartingScreen extends javax.swing.JFrame
{
	...
	private void createBulletinTableModel() {
        ...
        bulletinDTM = DomainFacade.getInstance().addBulletinsToTableModel(bulletinDTM);
    ...
    private void getAndSetHistory(){
        ...
        this.historyTable.setModel(DomainFacade.getInstance().updateHistoryTable((DefaultTableModel) this.historyTable.getModel(), bulletinId));
